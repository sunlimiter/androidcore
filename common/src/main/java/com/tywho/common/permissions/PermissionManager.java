...
public class PermissionManager implements OnPermissionCallback {
    ...
    public boolean checkPermission(Activity activity, String... permission) {
        return mPu.checkPermission(activity, permission)==null || mPu.checkPermission(activity, permission).size()==0;
    }
    ...
    public void requestPermission(Object obj, OnPermissionCallback callback, String... permission) {
        requestPermission_(obj, callback, "", registerCallback(obj, callback, permission));
    }
     ...
     * @param permission 权限
     */
    public void requestPermission_(Object obj, OnPermissionCallback callback, String hint,
                                   String... permission) {
