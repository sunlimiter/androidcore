...
public class LogUtils {
    ...
    private static final String TAG = "tywholog";
    ...
    public static void i(String... msg) {
        if (FileLogUtils.isDebug) printLog(I, msg);
    }

    public static void d(String... msg) {
        if (FileLogUtils.isDebug) printLog(D, msg);
    }

    public static void w(String... msg) {
        if (FileLogUtils.isDebug) printLog(W, msg);
    }

    public static void e(String... msg) {
        if (FileLogUtils.isDebug) printLog(E, msg);
    }

    public static void v(String... msg) {
        if (FileLogUtils.isDebug) printLog(V, msg);
    }

    // 下面是传入自定义tag的函数
    public static void i(String tag, String msg) {
        if (FileLogUtils.isDebug) Log.i(tag, msg);
    }

    public static void d(String tag, String msg) {
        if (FileLogUtils.isDebug) Log.d(tag, msg);
    }

    public static void w(String tag, String msg) {
        if (FileLogUtils.isDebug) Log.w(tag, msg);
    }

    public static void e(String tag, String msg) {
        if (FileLogUtils.isDebug) Log.e(tag, msg);
    }

    public static void v(String tag, String msg) {
        if (FileLogUtils.isDebug) Log.v(tag, msg);
    }

    //带异常的
    public static void i(String tag, String msg, Throwable tr) {
        if (FileLogUtils.isDebug) Log.i(tag, msg, tr);
    }

    public static void d(String tag, String msg, Throwable tr) {
        if (FileLogUtils.isDebug) Log.d(tag, msg, tr);
    }

    public static void w(String tag, String msg, Throwable tr) {
        if (FileLogUtils.isDebug) Log.w(tag, msg, tr);
    }

    public static void e(String tag, String msg, Throwable tr) {
        if (FileLogUtils.isDebug) Log.e(tag, msg, tr);
    }

    public static void v(String tag, String msg, Throwable tr) {
        if (FileLogUtils.isDebug) Log.v(tag, msg, tr);
    }
