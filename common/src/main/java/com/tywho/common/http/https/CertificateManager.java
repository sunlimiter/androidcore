package com.tywho.common.http.https;
...
/**
 * Created by limit on 2017/5/23/0023.
 */

public class CertificateManager {


    public static final String CER_12306_CONTENT = "" +
            "-----BEGIN CERTIFICATE-----\n" +
    ...
    public static InputStream[] trustedCertificatesInputStream() {
        ...
        try {
            inputStream[0] = CommonConfig.APPLICATION.getAssets().open("srca.cer");
        } catch (IOException e) {
            e.printStackTrace();
        }
        return inputStream;
